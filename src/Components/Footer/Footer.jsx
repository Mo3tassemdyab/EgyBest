...
export default function Footer() {
  ...
  <div className='container h-25 px-4 px-sm-5 mb-5'>
      <div className='row'>
          ...
          <div className="col-lg-4 mb-5">
              <div className='text-white text-center'>
                  ...
                  <p>EgyBest is a website that is connected to themoviedb which is a movies database to give you all the movies' information that you need</p>
              </div>
          </div>
  ...
  <div className='p-4 text-center footer2'>
      <p className='text-white m-2'>Copyright © EgyBest 2022</p>
  </div>
</footer>
}
